                            ...
                            <div className="row h-100 justify-content-center align-items-center">
                                ...
                                <div className="col-lg-6 col-md-12">
                                    <div className="hero-content pl-4">
                                        <h1>Partying and innovating unlike you know it.</h1>
                                        <p>Our passion to work hard and have a good time has led us right to this. House Party capital of the world.<br></br> #BreezyClub</p>
                                        
                                        <Link href="#">
                                            <a className="btn btn-primary">Party with Breezy</a>
                                        </Link>
                                        <Link href="#">
                                            <a
